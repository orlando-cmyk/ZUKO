  ...
  return (
    <div style={{
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: 14, width: '100%', maxWidth: 320 }}>
        ...
        {/* La Pecera — Dashboard admin */}
        <button
          onClick={() => router.push('/dashboard')}
          style={{
            padding: '20px 24px', borderRadius: 16, border: '1.5px solid #e2e8f0',
        ...
        >
          ...
          <div style={{ marginLeft: 'auto', fontSize: 18, color: '#22c55e' }}>→</div>
        </button>

        {/* Mi Laguna — Vista personal */}
        <button
        ...
        >
          ...
          <div style={{ marginLeft: 'auto', fontSize: 18, color: '#3b82f6' }}>→</div>
        </button>
      </div>
    </div>
  )
